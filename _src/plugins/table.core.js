...
(function () {
    ...
    UETable.prototype = {
        ...
        insertRow:function (rowIndex, sourceCell) {
            ...
            var styelCell = this.table.rows[0].cells[0]||this.table.rows[this.table.rows.length-1].cells[0];
            ...
            if (rowIndex == 0 || rowIndex == this.rowsNum) {
                for (var colIndex = 0; colIndex < numCols; colIndex++) {
                    ...
                    // cell.setAttribute('style', "padding:6px 6px; border: 1px solid #d3d3d3")
                    cell.setAttribute('style', styelCell.style.cssText)
                    cell.setAttribute('width', sourceCell.getAttribute('width'));
                    row.appendChild(cell);
        ...
        insertCol:function (colIndex, sourceCell, defaultValue) {
            var rowsNum = this.rowsNum,
                rowIndex = 0,
                tableRow, cell,
                backWidth = this.table.offsetWidth,
                isInsertTitleCol = typeof sourceCell == 'string' && sourceCell.toUpperCase() == 'TH';
            var styelCell = this.table.rows[0].cells[0];
            ...
            //框选时插入不触发contentchange，需要手动更新索引
            this.update();
            this.updateWidth(backWidth, defaultValue || {tdPadding:6, tdBorder:1});
        },
        updateWidth:function (width, defaultValue) {
            var table = this.table,
                maxCols = this.getMaxCols(table);
                // hzzhouming 写信页面有20px padding
                tmpWidth = UETable.getWidth(table) - defaultValue.tdPadding * 2 - defaultValue.tdBorder + width;
            // if (tmpWidth > (table.ownerDocument.body.offsetWidth -20)) {
            ...
            var changeValue = width - (totalWidth + (17*maxCols + (maxCols+1) + defaultValue.tdPadding * 2* maxCols));
            if(maxCols<=30){
                ...
                table.setAttribute("width", (totalWidth + (17*maxCols + (maxCols+1) + defaultValue.tdPadding * 2* maxCols)));
            }
